...
const App = () => {
  ...
  const handlePrivateMessage = (message) => {
    ...
    // THE FIX: Always use the character name provided by the server in the message.
    // This avoids the timing bug where the local 'myCharacter' state might not be set yet.
    const newMessage = {
