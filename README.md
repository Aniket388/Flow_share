FlowShare: Your Private S.H.I.E.L.D. Network :

About The Project:

Let's be honest: sharing files online can be a real pain. You're either wrestling with email attachment limits, navigating a maze of cloud storage folders, or using some sketchy, ad-filled website. It's ridiculous. I got tired of it, so I built FlowShare.
...
Drag & Drop: Click anywhere in that same box to open your file explorer and select as many files as you want (just keep the total under 100MB).

Send Intel (Notes): Got a quick message, link, or code snippet? Type or paste it into the "Share a Note" box.

Choose Your Target: In the "Available Marvel Heroes" list, just click on the names of the heroes you want to send your stuff to. They'll light up so you know they're selected.
